  ...
  return (
    <Container id="about" maxWidth="lg" sx={{ py: { xs: 8, md: 15 } }}>
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={{ xs: 6, md: 10 }} alignItems="center">
        ...
        {/* Αριστερή Στήλη: Φωτογραφία */}
        <Box sx={{ flex: 1, position: 'relative', width: '100%' }}>
          <Box sx={{ 
            position: 'absolute', top: 20, left: 20, width: '100%', height: '100%', 
            border: '3px solid', borderColor: 'primary.main', borderRadius: '12px', zIndex: 0 
          }} />
          <Box
            component="img"
            src="/alex-img3.jpg"
            ...
            sx={{
              width: '100%', borderRadius: '12px', display: 'block', position: 'relative', zIndex: 1,
              filter: 'grayscale(10%) contrast(1.1)', boxShadow: '0 20px 40px rgba(0,0,0,0.4)'
            }}
          />
        </Box>
        ...
        <Box sx={{ flex: 1.2, zIndex: 1 }}>
          ...
          <Typography variant="h2" sx={{ fontWeight: 900, mb: 3, mt: 1, textTransform: 'uppercase', lineHeight: 1 }}>
            ΠΡΟΠΟΝΗΣΗ ΜΕ <br />
            <span style={{ color: '#d32f2f' }}>ΤΟΝ ΑΛΕΞΑΝΔΡΟ</span>
          </Typography>
          ...
          <Stack direction="row" spacing={2} justifyContent="space-between" sx={{ mb: 5, textAlign: 'center' }}>
            <Box sx={{ flex: 1 }}>
              ...
              <Typography variant="caption" sx={{ color: '#aaa', display: 'block', fontWeight: 'bold' }}>ΕΤΗ ΕΜΠΕΙΡΙΑΣ</Typography>
            </Box>
            <Box sx={{ flex: 1 }}>
              ...
              <Typography variant="caption" sx={{ color: '#aaa', display: 'block', fontWeight: 'bold' }}>ΕΤΟΣ ΙΔΡΥΣΗΣ</Typography>
            </Box>
            <Box sx={{ flex: 1 }}>
              ...
              <Typography variant="caption" sx={{ color: '#aaa', display: 'block', fontWeight: 'bold' }}>REAL BOXING</Typography>
            </Box>
          </Stack>

          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
            <Button variant="contained" size="large" href="#contact" sx={{ px: 5, py: 1.5, fontWeight: 900, fontSize: '1rem' }}>
              ΚΛΕΙΣΕ ΘΕΣΗ
            </Button>
            <Button variant="outlined" size="large" href="#gallery" sx={{ px: 5, py: 1.5, fontWeight: 900, fontSize: '1rem', color: 'white', borderColor: 'rgba(255,255,255,0.3)' }}>
              ΔΕΣ ΤΟΝ ΧΩΡΟ
            </Button>
          </Stack>
        </Box>
